...
#roscore
#rosrun rviz rviz
#roslaunch can2ros_wheele wheele_sim.launch
#rosrun map_server map_server Downloads/ros_playback_helpers/big_run_map1u_clean_append6.yaml
# amcl launch will not work because it needs a /scan topic to initialize the odom to map tf, used static transform
#roslaunch light_scan_sim scan_sim.launch
